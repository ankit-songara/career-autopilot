...
- [ ] I have read [CONTRIBUTING.md](https://github.com/ankit-songara/career-autopilot/blob/main/CONTRIBUTING.md)
...
- [ ] My changes respect the [Data Contract](https://github.com/ankit-songara/career-autopilot/blob/main/DATA_CONTRACT.md) (no modifications to user-layer files)
