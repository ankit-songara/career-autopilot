...
```bash
git fetch https://github.com/ankit-songara/career-autopilot.git main || {
...
> **Changelog:** not available for v{remote}. The release notes are at https://github.com/ankit-songara/career-autopilot/releases
